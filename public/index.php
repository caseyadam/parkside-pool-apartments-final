  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div>
            <span id="time">Monday-Friday: 9:00am - 5:30pm</span>
            <br/>
            <span id="time">Saturday: 10:00am - 5:00pm</span>
            <br/>
            <span id="time">Sunday: 1:00pm - 5:00pm</span>
          </div>
      </div>
  ...
  <div class="card-deck">
    <div class="card mx-auto" >
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item text-center">$600-$800</li>
      </ul>
      <div class="card-body">
...
<!-- ONE BEDROOM CARD -->
    <div class="card mx-auto" >
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item text-center">$800-$1000</li>
      </ul>
      <div class="card-body">
...
<!-- TWO BEDROOM CARD -->
    <div class="card mx-auto" >
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item text-center">$1000-$1200</li>
      </ul>
      <div class="card-body">
      ...
      <div class="row">
        <div class="col">
          ...
          <ul>
            ...
            <li>&bull; Crown molding and two-tone paint scheme</li>
            <li>&bull; Spacious walk-in closets</li>
            <li>&bull; Electrical heating and air conditioning units</li>
            <li>&bull; ENERGY STAR ® appliances</li>
            <li>&bull; Sustainable apartment fixtures and HVAC equipment</li>
            <li>&bull; Disposal</li>
            <li>&bull; Dishwasher</li>
            <li>&bull; Refrigerator</li>
            <li>&bull; Range and microwave</li>
          </ul>
        </div>
        ...
        <div class="col">
          ...
          <ul>
            <li>&bull; Fitness center open 24 hours with cardio and strength equipment</li>
            <li>&bull; Sparkling swimming pool and sauna</li>
            <li>&bull; Tennis court available to all residents and guests</li>
...
<div id="photo-boxes" class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-6 order-md-1 order-xl-1" id="box-info">
      ...
      <p>Everyone has their own definition of a healthy lifestyle, so we offer a variety of equipment including treadmills, bikes, free weights, and machines.</p>
    </div>
  </div>
      ...
      <div class="col-sm-6 text-center">
        <div id="contact-info">
          ...
          <div id="info">
            ...
            <br/>
            <span>Sunday: 1:00pm - 5:00pm</span>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-6" id="footer-icons">
        <ul class="list-inline" id="center-right">
          ...
          <!-- Modal -->
            <div class="modal fade" id="fairHousingModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
